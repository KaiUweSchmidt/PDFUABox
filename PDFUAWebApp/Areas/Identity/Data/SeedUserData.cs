...
public static class SeedUserData
{
    public static async void CreateUsersAsync(IServiceProvider serviceProvider)
    {
        ...
        PDFUABoxUser adminUser = new PDFUABoxUser
        {
            ...
            NormalizedEmail = "administrator@pdfuabox.de".ToUpperInvariant(),
            UserName = "administrator@pdfuabox.de",
            NormalizedUserName = "administrator@pdfuabox.de".ToUpperInvariant(),
        ...
        adminUser = new PDFUABoxUser
        {
            ...
            NormalizedEmail = "kai-uwe.schmidt@gmx.de".ToUpperInvariant(),
            UserName = "kai-uwe.schmidt@gmx.de",
            NormalizedUserName = "kai-uwe.schmidt@gmx.de".ToUpperInvariant(),
            PhoneNumber = "+111111111111",
            EmailConfirmed = true,
            PhoneNumberConfirmed = true,
            SecurityStamp = Guid.NewGuid().ToString("D"),
