...
namespace PDFUABox.WebApp.Areas.Identity.Pages.Account.Manage
{
    public class ExternalLoginsModel : PageModel
    {
        ...
        /// </summary>
        public IList<UserLoginInfo> CurrentLogins { get; } = new List<UserLoginInfo>();

        /// <summary>
        ///     This API supports the ASP.NET Core Identity default UI infrastructure and is not intended to be used
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        public IList<AuthenticationScheme> OtherLogins { get; } = new List<AuthenticationScheme>();
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            var externalSchemes = await _signInManager.GetExternalAuthenticationSchemesAsync().ConfigureAwait(false);
            var filtered = externalSchemes
            ...
            if (_userStore is IUserPasswordStore<PDFUABoxUser> userPasswordStore)
            {
